...
var schema = new Schema({
  ...
  orientation_complete: { type: Boolean, default: false },
  background_complete: { type: Boolean, default: false },
  affiliation: { type: String, required: '{PATH} is required' },
  special_ed: { type: Boolean, default: false },
  language_ed: { type: Boolean, default: false },
